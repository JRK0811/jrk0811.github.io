$(function() {
	...
	var categories = window.cats = new CategoriesCollection([
		...
		{
			name: 'Aramid',
			icon: 'General/aramid.png',
			type: 'Farmstationen',
			enabled: true
		},
		{
			name: 'Plastik',
			icon: 'General/plastik.png',
			type: 'Farmstationen',
			enabled: true
		},
		{
			name: 'Chicken',
			icon: 'General/chicken.png',
			type: 'Farmstationen',
			enabled: true
		},
		{
			name: 'Morphin',
			icon: 'General/morphin.png',
			type: 'Farmstationen',
			enabled: true
		},
		{
			name: 'Natrium',
			icon: 'General/natrium.png',
			type: 'Farmstationen',
			enabled: true
		}
	]);
	...
	var MapView = Backbone.View.extend({
		...
		initialize: function() {
			...
			this.mapDetails = { 'Atlas': '#0fa8d2', 'Satellite': '#143d6b' };
			this.mapOptions = {
				center: new google.maps.LatLng(75, -123),
				zoom: 4,
